...
export default Gameboard = ({navigation, route}) => {
    ...
    const selectDicePoints = (i) => {
        if (nbrOfThrowsLeft === 0) {
            ...
            setStatus('You have ' + nbrOfThrowsLeft + ' Throws left!');
        }
    }
    ...
    const throwDices = () => {
        ...
        setDiceSpots(spots);
        setStatus('Choose dices and then throw again');
    }
    ...
    function getDicePointsColor(i) {
        return (selectedDicePoints[i] && !gameEndStatus) ? "black" : "blue"
    }
